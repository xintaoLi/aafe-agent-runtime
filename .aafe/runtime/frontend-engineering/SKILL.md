...
1. `.aafe/runtime/frontend-engineering/rules/pattern-gate.md` — 只有它可以在启用判定前读取
2. `.aafe/runtime/frontend-engineering/rules/pattern-composition.md`
3. `.aafe/runtime/frontend-engineering/rules/pattern-selection.md`
4. `.aafe/runtime/frontend-engineering/rules/pattern-boundary.md`、`pattern-overengineering.md`、`anti-pattern.md`
5. 命中的模式域规则：`.aafe/runtime/frontend-engineering/rules/<domain>-rules.md`
...
通信、数据访问和性能问题。映射见 `.aafe/runtime/frontend-engineering/skills/ddd-pattern-bridge/SKILL.md`。
