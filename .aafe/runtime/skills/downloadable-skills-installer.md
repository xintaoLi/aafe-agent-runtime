...
This skill is only for the GitHub Agent SKILLS download scenario. It must not be used to initialize or update `.aafe/runtime` inside a business project.
...
- The user wants to generate or refresh project `.aafe/runtime/`, `.aafe.config.json` or editor runtime files.
