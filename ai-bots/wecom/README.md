...
| 场景 | 内容 | 卡片操作 |
| --- | --- | --- |
| 执行中 | 当前状态、公开进展、最近工作记录 | 查看完整过程 / 终止 |
| 等待反馈 | ⏸ 等待补充 / 确认、需要用户回答的问题、已完成部分、后续步骤 | 查看完整过程 / 补充信息 |
| 成功 / 失败 / 终止 | 对应状态、一次结果说明、可用文件/PR 信息 | 查看完整过程 |
...
- 任务卡片底部最多展示两个按钮，「查看状态」放在右上角「更多操作」菜单中，避免三按钮平分宽度时中文文案被截断。
