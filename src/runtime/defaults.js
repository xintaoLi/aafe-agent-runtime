...
import { analyzeModulePatternFit, analyzePatternFit } from '../patterns/PatternAdvisor.js';
...
export const defaultPipelines = {
  feature: { steps: [{ skill: 'memory-recaller' }, { skill: 'architect' }, { skill: 'ddd-discovery' }, { gate: 'ddd_gate' }, { skill: 'module-decomposer' }, { skill: 'pattern-interviewer' }, { skill: 'pattern-selector' }, { skill: 'module-pattern-selector' }, { gate: 'pattern_gate' }, { skill: 'evolution-predictor' }, { gate: 'architecture_gate' }, { skill: 'adr-generator' }, { gate: 'implementation_gate' }, { skill: 'refactor-critic' }, { skill: 'memory-writer' }, { gate: 'merge_gate' }] },
  'domain-feature': { steps: [{ skill: 'memory-recaller' }, { skill: 'ddd-discovery' }, { skill: 'bounded-context-mapper' }, { skill: 'aggregate-designer' }, { skill: 'domain-event-designer' }, { gate: 'ddd_gate' }, { skill: 'architect' }, { skill: 'module-decomposer' }, { skill: 'pattern-interviewer' }, { skill: 'pattern-selector' }, { skill: 'module-pattern-selector' }, { gate: 'pattern_gate' }, { skill: 'ddd-implementation-planner' }, { gate: 'implementation_gate' }, { skill: 'adr-generator' }, { skill: 'refactor-critic' }, { skill: 'memory-writer' }, { gate: 'merge_gate' }] },
  'pattern-feature': { steps: [{ skill: 'memory-recaller' }, { skill: 'architect' }, { skill: 'module-decomposer' }, { skill: 'pattern-interviewer' }, { skill: 'pattern-selector' }, { skill: 'module-pattern-selector' }, { gate: 'pattern_gate' }, { skill: 'pattern-implementation-planner' }, { skill: 'adr-generator' }, { gate: 'implementation_gate' }, { skill: 'refactor-critic' }, { skill: 'memory-writer' }, { gate: 'merge_gate' }] },
  ...
  'graph-feature': { steps: [{ skill: 'memory-recaller' }, { skill: 'architect' }, { skill: 'graph-architect' }, { skill: 'layout-strategy-selector' }, { skill: 'runtime-evolution-predictor' }, { skill: 'module-decomposer' }, { skill: 'pattern-interviewer' }, { skill: 'pattern-selector' }, { skill: 'module-pattern-selector' }, { gate: 'pattern_gate' }, { gate: 'architecture_gate' }, { skill: 'adr-generator' }, { skill: 'refactor-critic' }, { skill: 'memory-writer' }, { gate: 'merge_gate' }] }
};
...
export const defaultSkills = {
  ...
  'module-pattern-selector': {
    async run(context) {
      const fit = analyzeModulePatternFit({ prompt: context.input?.request });
      return { status: fit.status, summary: 'Module-level pattern selection completed', artifacts: { module_pattern_selection: fit.modules }, risks: [], nextHints: [] };
    }
  },
